...
const Job = ({ job}) => {
  ...
  // const jobId = "jfdhwdcjdcjbjdhjsbc";
  ...
  return (
    <div className="p-5 rounded-md shadow-xl bg-white border border-gray-100 transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl">
